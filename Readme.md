...
Realizamos el cambio desde Git Hub haciendo un commit, el cambio realizado es el texto añadido:  
![img_4.png](img_4.png)
- Utiliza fetch para descargar los cambios realizados en tu repositorio.  
Para ello haremos git fetch origin en la terminal de PyCharm con lo que se hará el commit ya hecho desde Git Hub. Paso seguido haremos git merge para poder ver los cambios hechos.  
![img_5.png](img_5.png)  
![img_6.png](img_6.png)
